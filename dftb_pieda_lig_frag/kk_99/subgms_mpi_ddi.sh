...
export GMSPATH=/mnt/lustre/koa/lab/tsqc_group/installed_software/gms_mpi_noDS
...
srun --mpi=pmix -N $NNODES -n $NCPUS2 --ntasks-per-node=$PPN2 --export=ALL --cpu-bind verbose,depth \
  $GMSPATH/gamess.00.x >& $output
